...
public class UpdateProductViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {

    public TextView productNameLabel, productPriceLabel, productAmountLabel, productDescriptionLabel;
    public ImageView productImageView;
    public ConstraintLayout updateButton, deleteButton;
    public ItemClickListener itemClickListener;

    public UpdateProductViewHolder(View itemView) {
        super(itemView);
